...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        ...
        request.setLastName("Razzaq");
        request.setEmail("razzaq@example.com");
        ...
        mockMvc.perform(
            ...
            assertEquals("Razzaq", response.getData().getLastName());
            assertEquals("razzaq@example.com", response.getData().getEmail());
